...
/**
 * Renderiza o corpo (body/ficha de compensação) do boleto do Banco do Brasil
 *
 ...
 * @param {string} _ref.billValue - Valor unitário
 * @param {string} _ref.amount - Quantidade
 * @param {string} _ref.currencyType - Espécie da moeda (ex: 'R$')
 ...
 * @param {string} _ref.payer.name - Nome do pagador
 * @param {string} _ref.payer.registerNumber - CPF/CNPJ do pagador
 * @param {string} _ref.payer.street - Rua do pagador
 * @param {string} _ref.payer.number - Número do endereço
 * @param {string} _ref.payer.complement - Complemento
 * @param {string} _ref.payer.district - Bairro
 * @param {string} _ref.payer.city - Cidade
 * @param {string} _ref.payer.state - Estado (UF)
 * @param {string} _ref.payer.postalCode - CEP
 * @param {Object} [_ref.guarantor] - Dados do sacador/avalista (opcional)
 * @param {string} _ref.guarantor.name - Nome do avalista
 * @param {string} _ref.guarantor.registerNumber - CPF/CNPJ do avalista
 * @param {string} _ref.guarantor.street - Rua do avalista
 * @param {string} _ref.guarantor.number - Número do endereço
 * @param {string} _ref.guarantor.district - Bairro
 * @param {string} _ref.guarantor.city - Cidade
 * @param {string} _ref.guarantor.state - Estado (UF)
 * @param {string} _ref.guarantor.postalCode - CEP
 * @param {string} _ref.instructions - Instruções para o pagamento
 * @param {string} _ref.bank - Código do banco (ex: '001-9')
 * @param {string} [_ref.qrcode] - Código QR (opcional)
 * @param {string} [_ref.barcodeData] - Dados do código de barras para gerar QR Code
 *
...
export default function(doc, _ref, _ref2) {
  ...
  if (_ref.qrcode !== '' && _ref.qrcode !== null) {
    doc.image(
      'node_modules/boleto-pdf/dist/qrcodes/' + _ref.barcodeData + '.png',
      startX + smallGutterX + 300,
      startY + boxHeight * 5 + gutterY + 30,
      {
        height: 75
      }
    )
