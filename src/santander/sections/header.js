...
/**
 * Renderiza o cabeçalho (header/recibo) do boleto do Santander
 *
 ...
 * @param {string} _ref.documentType - Tipo do documento
 ...
 * @param {Object} [_ref.recibo.guarantor] - Dados do avalista no recibo (opcional)
