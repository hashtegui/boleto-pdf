...
/**
 * Gera o PDF do boleto do Santander
 *
...
export default function(bill) {
  return new Promise(function(resolve, reject) {
    ...
    var config = {
      ...
      logo: path.join(__dirname, 'logos/logo-santander.jpg'),
      //logomarca: path.join(__dirname, fill),
      bodyStarY: realStartY + 25 * 14 + 10
    }
    ...
    try {
      ...
      barcode(doc, MARGIN, realStartY + 30 * 23, bill.barcodeData)
    } catch (err) {
      reject(err)
    }
