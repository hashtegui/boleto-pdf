...
import generatePDF from '../../src/sicoob/generate-pdf'
...
describe('genaratePdf main functionality', () => {
  ...
  it('generatePdf should generate a valid pdf file', async () => {
    const boleto = {
      barcodeData: '75691726700000009901234567890123456789012',
      digitableLine: '75691.23456 67890.123458 67890.123456 1 72670000000990',
      ...
      formatedOurNumber: '1/12345678-9',
